...
namespace LoanTypeMicroservice.Controllers
{
    ...
    public class EducationLoansController : ControllerBase
    {
        ...
        public EducationLoansController(LoanTypeDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<EducationLoan>> PostEducationLoan(EducationLoan educationLoan)
        {
            ...
            return CreatedAtAction("GetEducationLoan", new { id = educationLoan.CustId }, educationLoan);
        }
        ...
        {
            return _context.EducationLoans.Any(e => e.CustId == id);
        }
    }
}
